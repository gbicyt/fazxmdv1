...
async function startNaze() {
    const naze = nazeConnect({
        ...
        browser: ['Fazx Bot Studio |','Ⓒ FBS 2023','1.0.0'],
        auth: state
    })
    ...
    // Get Profile Picture Group
       ...
       naze.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nGroup telah ditutup oleh admin, Sekarang hanya admin yang dapat mengirim pesan !`, `Group Settings Change Message by Fazx Bot`, [])
       } else if(pea[0].announce == false) {
       naze.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nGroup telah dibuka oleh admin, Sekarang peserta dapat mengirim pesan !`, `Group Settings Change Message by Fazx Bot`, [])
       } else if (pea[0].restrict == true) {
       naze.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nInfo group telah dibatasi, Sekarang hanya admin yang dapat mengedit info group !`, `Group Settings Change Message by Fazx Bot`, [])
       } else if (pea[0].restrict == false) {
       naze.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nInfo group telah dibuka, Sekarang peserta dapat mengedit info group !`, `Group Settings Change Message by Fazx Bot`, [])
       } else {
       naze.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nGroup Subject telah diganti menjadi *${pea[0].subject}*`, `Group Settings Change Message by Fazx Bot`, [])
     }
    })
        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://divedigital.id/wp-content/uploads/2021/10/1-min.png'
                }
         ...
         const reSize = async(buffer, ukur1, ukur2) => {
             ...
             resolve(ab)
                ...
                try {
                    ...
                    ppgroup = 'https://drscdn.500px.org/photo/1062124644/m%3D900/v2?sig=54e1da398547f0aba2597ffe838d8954f180a78efdbd719e8e1c18a34179e226'
                }
                ...
                let nyoutube = ('© FBS 2023 | Fazx Bot Studio by Fazx Store\nYouTube:\nhttps://www.youtube.com/channel/UC4drGxmbr7nPvbShL9OaptA')
                let teks1 = `*Halo Kak @${num.split('@')[0]}*\n*Selamat Datang Di Grup*\n*${metadata.subject}*\n*Jangan Lupa Kenalan Yahh*\n_~Admin_`
